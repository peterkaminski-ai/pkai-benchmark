...
The PKAI benchmark: **the best current understanding of what a personal AI agent could be** — a house that grows larger, with foreground and background agents; a charter with its safety sections; where instructions take hold; the pull protocol in full; every skill and the whole shelf.
...
- **`HOUSE.md`** — the house in full, grown large: several agents, the desk, shared state and who owns it, background instances as a habit, books and their boxes.
