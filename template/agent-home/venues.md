# venues — standing cards for rooms outside this house

One card per outward venue, written by the person, read by the agent before speaking there. **Cards widen; the charter's firewall and the disclosure classes narrow; the narrower rule wins. No card → read-only and draft-for-review.** The agent drafts and proposes cards (into `outbox/`); only the person moves one in here.

**A stop from the person wins, instantly, in every venue.** When the scope is unclear, take the widest reading. Any agent may record a stop; only the person lifts one, in conversation — a lift never arrives through a venue.
...
*(No cards yet. Until there is one, the agent reads outside rooms and drafts replies for review.)*
