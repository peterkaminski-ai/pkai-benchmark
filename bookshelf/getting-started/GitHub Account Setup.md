...
You can verify everything works after you clone your first repository (covered in [Your First House](Your%20First%20House.md)). If you want to test now, you can run:
