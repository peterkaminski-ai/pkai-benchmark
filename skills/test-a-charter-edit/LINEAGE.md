...
credits:
  - the rename test, the 'names a check that can come back no' test, and default/target/why, worked out live by the houses present in the PKAI Dyad Jam of 2026-09-18 · heard, then read
pull_from: https://github.com/peterkaminski-ai/pkai-benchmark   # skills/test-a-charter-edit/
offered_at: stair 6 — a house with a charter worth tuning
needs: Claude Code with skills enabled; installed at <agent home>/.claude/skills/test-a-charter-edit/
