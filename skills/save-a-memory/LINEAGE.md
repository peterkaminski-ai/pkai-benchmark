...
credits:
  - the memory conventions of Pete Kaminski's own agents (one fact, one file, one index line, a Why line), as carried in the kit's personas since v1 · read; the heard-or-read provenance tag, proposed in the ØSphera jam of 2026-09-20 · read
pull_from: https://github.com/peterkaminski-ai/pkai-benchmark   # skills/save-a-memory/
offered_at: stair 5 — the first house
needs: Claude Code with skills enabled; installed at <agent home>/.claude/skills/save-a-memory/
