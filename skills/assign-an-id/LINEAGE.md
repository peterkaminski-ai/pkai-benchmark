...
credits:
  - the `yymmdd-aa` handle of the house's boards ('textpile-shaped', 2026-08), the codename allocator's 'computed, never reused' rule (2026-09-13), session-log naming, and the SPDX-style namespaced immutable identifiers of the IFP assumptions registry (2026-07–08) · read; Pete, 2026-09-22: 'ID numbers; we have the textpile one' · heard
pull_from: https://github.com/peterkaminski-ai/pkai-benchmark   # skills/assign-an-id/
offered_at: stair 5 — the first house
needs: Claude Code with skills enabled; installed at <agent home>/.claude/skills/assign-an-id/
