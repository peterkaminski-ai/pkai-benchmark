...
credits:
  - the pull mechanism as Pete Kaminski stated it in the ØSphera jam of 2026-09-20 (benchmark-and-pull, never push-and-replace, for sovereignty, not breakage; the house reports what it valued and where it diverged and did better) · heard, then read from the fair copy
pull_from: https://github.com/peterkaminski-ai/pkai-benchmark   # skills/pull-from-benchmark/
offered_at: stair 4 and up — any house that will take a later release
needs: Claude Code with skills enabled; installed at <agent home>/.claude/skills/pull-from-benchmark/
