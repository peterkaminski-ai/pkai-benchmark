...
credits:
  - the authority table and 'when they widen a boundary, save it as a feedback memory quoting what they said' from the kit's personas since v1 · read
pull_from: https://github.com/peterkaminski-ai/pkai-benchmark   # skills/widen-a-boundary/
offered_at: stair 5 — the first house
needs: Claude Code with skills enabled; installed at <agent home>/.claude/skills/widen-a-boundary/
